...
# Copyright (C) 2020-2022, Project Pixelstar
...
pixelstar_manifest = ".repo/manifests/snippets/pixelstar.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    pixelstarm = load_manifest(pixelstar_manifest)
    ...
    for repo in repos:
        ...
        if exists_in_tree(pixelstarm, repo_path) != None:
            existing_m_project = exists_in_tree(pixelstarm, repo_path)
